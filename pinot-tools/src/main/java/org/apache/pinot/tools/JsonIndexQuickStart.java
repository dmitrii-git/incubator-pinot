...
public class JsonIndexQuickStart {
  ...
  public void execute()
    ...
    File baseDir = new File(quickstartTmpDir, "personJson");
    File dataDir = new File(quickstartTmpDir, "rawdata");
    Preconditions.checkState(dataDir.mkdirs());

    File schemaFile = new File(baseDir, "personJson_schema.json");
    File dataFile = new File(baseDir, "personJson_data.csv");
    File tableConfigFile = new File(baseDir, "personJson_offline_table_config.json");
